(function(){
    ...
    /**
     //TODO: Routes mit REST-Tools überprüfen?
     //TODO: Login/Logout feature
     //TODO: Session feature
     * */
    window.onload = function(){
        ...
        $("#post_button").on("click", saveUrl);
    };

    /**
     * Updating post times in 30s intervals
     * */
    ...
    function saveUrl(){
        ...
        var obj = {
            title: url,
            id: "zafer" + parseInt(new Date().getTime()),
